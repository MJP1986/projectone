...
$(document).ready(function () {
  ...
  $("#sbutton").click(function () {
    ...
    var qURLFirst = "https://api.spoonacular.com/recipes/search?query=" + query + "&cuisine=" + cuisine + "&intolerances=" + intolerances + "&diet=" + diet + "&number=5&apiKey=874efe7482a6472e93947420655c6cad";
    $.ajax({
      url: qURLFirst,
      method: "GET"
      ...
      for (var i = 0; i < 3; i++) {
        ...
        $.ajax({
          ...
          for (index = 0; index < foodLinkArray.length; index++) {
            $("#fimage0" + index).attr("src", foodImgArray[index]);
            $("#fimage1" + index).attr("src", foodImgArray[index]);
            $("#fimage2" + index).attr("src", foodImgArray[index]);
            $("#fname0" + index).text(foodTitleArray[index]);
            $("#fname1" + index).text(foodTitleArray[index]);
            $("#fname2" + index).text(foodTitleArray[index]);
            $("#food-link0" + index).attr("href", foodLinkArray[index]);
            $("#food-link1" + index).attr("href", foodLinkArray[index]);
            $("#food-link2" + index).attr("href", foodLinkArray[index]);
